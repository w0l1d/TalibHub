...
const NavbarData: NavbarLink[] = [
    ...
    { route: '/studentProfile', icon: 'fa-solid fa-user', label: 'Profile', highlight: false },
    { route: '/news', icon: 'fa-solid fa-newspaper', label: 'News', highlight: false },
    { route: '/studentManagement', icon: 'fa-sharp fa-solid fa-shield-halved', label: 'Admin', highlight: true },
